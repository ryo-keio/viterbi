        ...
        //while (i < TEST) {   // 誤りが200回起きるまで，または100000回繰り返すまで
			...
			*/
			...
			for (j = 3; j < 259; j++) {
				...
				sum111[j] = ((s1 = (sum011[j-1] + dh1 + rh2)) < (s2 = (sum111[j-1] + dh1 + rh2))) ? s1 : s2;
				*/
				...
				/*
				sum000[i] = (sum000[i-1] + rcode[2*i] + rcode[2*i+1] < sum100[i-1] + (1-rcode[2*i]) + (1-rcode[2*i+1])) ? sum000[i-1] + rcode[2*i] + rcode[2*i+1] : sum100[i-1] + (1-rcode[2*i]) + (1-rcode[2*i+1]);
				sum001[i] = (sum000[i-1] + (1-rcode[2*i]) + (1-rcode[2*i+1]) < sum100[i-1] + rcode[2*i] + rcode[2*i+1]) ? sum000[i-1] + (1-rcode[2*i]) + (1-rcode[2*i+1]) : sum100[i-1] + rcode[2*i] + rcode[2*i+1];
				sum010[i] = (sum001[i-1] + (1-rcode[2*i]) + (1-rcode[2*i+1]) < sum101[i-1] + rcode[2*i] + rcode[2*i+1]) ? sum001[i-1] + (1-rcode[2*i]) + (1-rcode[2*i+1]) : sum101[i-1] + rcode[2*i] + rcode[2*i+1];
				sum011[i] = (sum001[i-1] + rcode[2*i] + rcode[2*i+1] < sum101[i-1] + (1-rcode[2*i]) + (1-rcode[2*i+1])) ? sum001[i-1] + rcode[2*i] + rcode[2*i+1] : sum101[i-1] + (1-rcode[2*i]) + (1-rcode[2*i+1]);
				sum100[i] = (sum010[i-1] + rcode[2*i] + (1-rcode[2*i+1]) < sum110[i-1] + (1-rcode[2*i]) + rcode[2*i+1]) ? sum010[i-1] + rcode[2*i] + (1-rcode[2*i+1]) : sum110[i-1] + (1-rcode[2*i]) + rcode[2*i+1]; 
				sum101[i] = (sum010[i-1] + (1-rcode[2*i]) + rcode[2*i+1] < sum110[i-1] + rcode[2*i] + (1-rcode[2*i+1])) ? sum010[i-1] + (1-rcode[2*i]) + rcode[2*i+1] : sum110[i-1] + rcode[2*i] + (1-rcode[2*i+1]); 
				sum110[i] = (sum011[i-1] + (1-rcode[2*i]) + rcode[2*i+1] < sum111[i-1] + rcode[2*i] + (1-rcode[2*i+1])) ? sum011[i-1] + (1-rcode[2*i]) + rcode[2*i+1] : sum111[i-1] + rcode[2*i] + (1-rcode[2*i+1]); 
				sum111[i] = (sum011[i-1] + rcode[2*i] + (1-rcode[2*i+1]) < sum111[i-1] + (1-rcode[2*i]) + rcode[2*i+1]) ? sum011[i-1] + rcode[2*i] + (1-rcode[2*i+1]) : sum111[i-1] + (1-rcode[2*i]) + rcode[2*i+1]; 
				*/
